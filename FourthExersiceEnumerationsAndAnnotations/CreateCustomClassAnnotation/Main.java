        ...
        while (true) {
            ...
            switch (commands[0].toLowerCase()) {
                ...
                case "compare":
                    ...
                    break;
                case "author":
                    System.out.println("Author: "+Weapon.class.getAnnotation(CustomAnnotation.class).author());
                    break;
                case "revision":
                    System.out.println("Revision: "+Weapon.class.getAnnotation(CustomAnnotation.class).revision());
                    break;
                case "description":
                    System.out.println("Class description: "+Weapon.class.getAnnotation(CustomAnnotation.class).description());
                    break;
                case "reviewers":
                    System.out.println("Reviewers: "+String.join(", ",Arrays.asList(Weapon.class.getAnnotation(CustomAnnotation.class).reviewers())));
                    break;
            }
        }
    }
