...
public class ListUtils {
    ...
    public static <T> void flatten (List<? super T> destination , List<List<? extends T>> allLists){
        for (List<? extends T> allList : allLists) {
            for (T t : allList) {
                destination.add(t);
            }
        }
    ...
    public static <T> void addAll (List<? super T> firstList, List<? extends T> secondList){
