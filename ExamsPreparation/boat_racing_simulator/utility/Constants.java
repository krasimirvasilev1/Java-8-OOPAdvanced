...
public final class Constants {
    ...
    public static final String DuplicateModelMessage = "An entry for the given models already exists.";

    public static final String NonExistantModelMessage = "The specified models does not exist.";
